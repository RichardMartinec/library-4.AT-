...
<head>
    ...
    <title>Borrow Ticket</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="css/style.css">
</head>
  <body>
    <form action="php/return_ticket_print.php" method="POST">
        <h2>Return ticket</h2><hr><br>       
        ...
        <div class="mb-3">
            <label for="borrowed" class="form-label">Returned</label>
             <select class="form-select" id="returned" name="pozicana">
        ...
        <button type="submit" class="btn btn-primary" name="return_ticket_print">Print return ticket</button>
    </form>
