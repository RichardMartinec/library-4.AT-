...
<head>
  ...
  <body>
    ...
    <form action="php/borrow_ticket_print.php" method="POST">
        <h2>Borrow ticket</h2><hr><br>       
        ...
        <button type="submit" class="btn btn-danger btn-3" name="borrow_ticket_print">Print borrow ticket</button>
    </form>
